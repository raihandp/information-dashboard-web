<script lang="ts">
	...
	let photos = [
		...
		{ id: 3, title: 'QR Code 3', imageSrc: 'https://via.placeholder.com/400x200?text=Foto+3' },
		{ id: 1, title: 'QR Code 4', imageSrc: 'https://via.placeholder.com/400x200?text=Foto+4' },
		{ id: 2, title: 'QR Code 5', imageSrc: 'https://via.placeholder.com/400x200?text=Foto+5' },
    ...
    <Card.Root>
        <Card.Content class="p-6">
            <div class="flex items-center justify-between space-x-4">
                <div class="flex-grow">
                    <h3 class="font-semibold tracking-tight">QR Code Layanan FIK</h3>
                    <p class="text-sm text-muted-foreground">Pindai QR Code layanan FIK di bawah ini</p>
                </div>
                <div>
                    <Dialog.Root>
                        <Dialog.Trigger>
